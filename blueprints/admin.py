...
from helper import redirect_back, allowed_file
...
def manage_post():
    ...
    pagination = Post.query.order_by(Post.timestamp.desc()).paginate(
        page, per_page=current_app.config['CLEARLOG_MANAGE_POST_PER_PAGE'])
...
def get_image(filename):
    return send_from_directory(current_app.config['CLEARLOG_UPLOAD_PATH'], filename)
